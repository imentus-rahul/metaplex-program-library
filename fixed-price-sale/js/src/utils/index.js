...
exports.findSecondaryMetadataCreatorsAddress = findSecondaryMetadataCreatorsAddress;
var validateMembershipToken = function (connection, me, ta) { return __awaiter(void 0, void 0, void 0, function () {
    var edition;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, mpl_token_metadata_1.Metadata.getEdition(connection, ta.data.mint)];
            case 1:
                edition = (_a.sent());
                return [2 /*return*/, edition.data.parent === me.pubkey.toString()];
        }
    });
}); };
