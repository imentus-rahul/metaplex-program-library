 ...
 */
export class SecondaryMetadataCreatorsAccountData implements SecondaryMetadataCreatorsAccountDataArgs {
  private constructor(
    readonly creators: definedTypes.mpl_token_metadata::state::Creator[]
  ) {}
  ...
  static fromArgs(args: SecondaryMetadataCreatorsAccountDataArgs) {
    return new SecondaryMetadataCreatorsAccountData(
      args.creators
    );
  }
